...
const BLUEPRINTS: Record<string, Blueprint[]> = {
  dairy: [
    ...
    },
    {
      ...
      basePrice: 85,
      mrpRatio: 1.15,
      brands: ['Amul Malai Fresh', 'Mother Dairy Paneer', 'Milky Mist Premium', 'Gowardhan Fresh Paneer', 'Nature Soy Tofu'],
    ...
    {
      item: 'Farm Fresh Curd / Dahi',
      hindi: 'ताजा दही',
      category: 'dairy',
      basePrice: 32,
      mrpRatio: 1.08,
      brands: ['Amul Masti Dahi', 'Mother Dairy Classic Dahi', 'Milky Mist Set Curd', 'Epigamia Greek Yogurt', 'Gowardhan Dahi'],
    ...
    {
      item: 'Pasteurized Salted Table Butter',
      hindi: 'मक्खन',
      category: 'dairy',
      basePrice: 56,
      mrpRatio: 1.08,
      brands: ['Amul Pasteurized', 'Mother Dairy Table Butter', 'Britannia Butter', 'Nutralite Doodhshakti'],
    ...
    },
    {
      ...
      basePrice: 42,
      mrpRatio: 1.12,
      brands: ['Harvest Gold', 'English Oven 100% Atta', 'Britannia Whole Wheat', 'Modern Brown Bread', 'The Health Factory Zero Maida'],
    ...
    },
    {
      ...
      basePrice: 125,
      mrpRatio: 1.15,
      brands: ['Amul Processed Cheese', 'Britannia Cheezza', 'Go Cheese Angles', 'Milky Mist Mozzarella Diced'],
    ...
    {
      item: 'Spiced Masala Buttermilk / Chhach',
      hindi: 'मसाला छाछ',
      category: 'dairy',
      basePrice: 15,
      mrpRatio: 1.05,
      brands: ['Amul Masti Spiced', 'Mother Dairy Tadka Chach', 'Nandini Spiced Buttermilk', 'Paper Boat Chaas'],
  ...
  staples: [
    {
      item: '100% Shudh Chakki Fresh Whole Wheat Atta',
      hindi: 'शुद्ध चक्की आटा',
      category: 'staples',
      basePrice: 215,
      mrpRatio: 1.18,
      brands: ['Aashirvaad Shudh Chakki', 'Fortune Chakki Fresh', 'Pillsbury Chakki Fresh', 'Nature Fresh Sampoorna', 'Tata Sampann Low GI'],
    ...
    },
    {
      ...
      basePrice: 110,
      mrpRatio: 1.25,
      brands: ['Daawat Rozana Super Basmati', 'India Gate Classic', 'Fortune Everyday Basmati', 'BB Royal Sona Masoori Steam Rice', 'Kohinoor Super Silver'],
    ...
    },
    {
      ...
      hindi: 'कुकिंग ऑयल (सूरजमुखी व सरसों)',
      category: 'staples',
      basePrice: 135,
      mrpRatio: 1.2,
      brands: ['Fortune Sunlite Sunflower', 'Saffola Gold Pro Healthy', 'Dhara Kachi Ghani Mustard', 'Gemini Pure Sunflower', 'Emami Healthy & Tasty'],
    ...
    },
    {
      ...
      basePrice: 165,
      mrpRatio: 1.2,
      brands: ['Tata Sampann Unpolished', 'Fortune Arhar Dal', 'Organic Tattva Toor Dal', 'BB Royal Premium Desi Toor'],
    ...
    },
    {
      ...
      basePrice: 130,
      mrpRatio: 1.18,
      brands: ['Tata Sampann Moong Dal', 'Fortune Moong Dhuli', 'Organic Tattva Organic Moong', 'BB Royal Moong Chilka'],
    ...
    },
    {
      ...
      basePrice: 26,
      mrpRatio: 1.12,
      brands: ['Tata Salt Vacuum Evaporated', 'Tata Salt Lite Low Sodium', 'Aashirvaad Iodised Salt', 'Catch Table Salt'],
    ...
    },
    {
      ...
      basePrice: 320,
      mrpRatio: 1.15,
      brands: ['Amul Pure Cow Ghee', 'Mother Dairy Desi Ghee', 'Gowardhan Pure Cow Ghee', 'Aashirvaad Svasti Pure Ghee', 'Patanjali Cow Ghee'],
...
export function generateDeterministicSku(globalIndex: number, categoryId: string, cityMultiplier = 1.0): Product {
  ...
  return {
    ...
    offers: generateStoreOffers(baseCalculatedPrice, mrp),
  };
}
